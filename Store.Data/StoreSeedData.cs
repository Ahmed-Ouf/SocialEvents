        ...
        private static List<Gadget> GetGadgets()
        {
            return new List<Gadget>
            {
                new Gadget {
                    ...
                    CategoryId = Guid.Parse("27D737AB-A403-4525-BAFA-6ECED06E9BB1"),
                    Price = 46.99m,
                    Image = "prontotec.jpg"
                },
                new Gadget {
                ...
                new Gadget {
                    ...
                    CategoryId = Guid.Parse("E8276A7B-DD1B-4C66-882C-680AFAFA8901"),
                    Price = 249.5m,
                ...
                new Gadget {
                    ...
                    CategoryId = Guid.Parse("3F6CB98B-2D12-45BE-A776-CC57360BA4F5"),
                    Price = 63.99m,
